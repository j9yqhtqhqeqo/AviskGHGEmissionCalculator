...
using the test data from Co2TestData.csv to ensure calculated values match expected results.
"""
...
class Co2EmissionsTestRunner:
    ...
    def load_test_data(self) -> List[Dict[str, Any]]:
        """Load test data from Co2TestData.csv file."""
        test_data = []
        ...
        try:
            ...
            print(f"✅ Loaded {len(test_data)} test cases from Co2TestData.csv")
            return test_data
